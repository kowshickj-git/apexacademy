...
const CONFETTI_COLORS = ["#14B8A6", "#10B981", "#0EA5E9", "#F59E0B", "#8B5CF6", "#F97316", "#EC4899"];
const BADGE_SKILLS = ["No Solder", "Row Logic", "Rail Power", "Circuit Build"];
...
export default function BreadboardsComplete({ xp, onClose }: Props) {
      ...
      >
        ...
        <div className="p-6">
          ...
          <div className="text-center mb-5">
            ...
            <h2 className="text-xl font-black text-white mb-1">Lesson Complete!</h2>
            <p className="text-xs text-white/40 font-mono">Breadboard Fundamentals — L09</p>
          </div>
          ...
          >
            ...
            <p
              ...
              style={{ background: "linear-gradient(to right, #14B8A6, #10B981)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}
            >
              {xp} XP
            </p>
          </div>
          ...
          <div className="mb-4">
            ...
            <div className="h-2 rounded-full overflow-hidden" style={{ background: "rgba(255,255,255,0.06)" }}>
              <div className="relative h-full rounded-full overflow-hidden" style={{ width: "85%", background: "rgba(20,184,166,0.2)" }}>
                <motion.div
                  initial={{ width: 0 }}
                  animate={{ width: "5.88%" }}
            ...
            <div className="flex flex-wrap gap-2">
              {BADGE_SKILLS.map((skill, i) => (
                <motion.div
                  ...
                  style={{ borderColor: "rgba(20,184,166,0.3)", background: "rgba(20,184,166,0.1)", color: "#14B8A6" }}
                >
                  ✓ {skill}
                </motion.div>
              ))}
          ...
          >
            ...
            <p className="text-sm font-bold text-white/85 group-hover:text-white transition-colors">
              Lesson 10: Multimeter Fundamentals
            </p>
            <p className="text-[10px] text-white/35 mt-0.5">Measure voltage, current, and resistance like a pro →</p>
          </Link>
