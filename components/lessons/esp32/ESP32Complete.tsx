...
const COLOR = "#06B6D4";
const CONFETTI_COLORS = [COLOR, "#22D3EE", "#FFFFFF", "#FFD700", "#FFC107", "#67E8F9", "#A5F3FC", "#FBBF24"];
...
const ALL_LESSONS = [
  ...
  "SPI", "CAN Protocol", "RS485", "IoT", "ESP32",
];

export default function ESP32Complete({ xp, onClose }: Props) {
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        style={{ borderColor: "rgba(6,182,212,0.4)", background: "rgba(5,5,20,0.97)", backdropFilter: "blur(20px)" }}
      ...
      >
        <div className="text-center mb-6">
          ...
          <h2 className="text-3xl font-black mb-1" style={{ color: COLOR }}>ESP32 Complete!</h2>
          <p className="text-sm mb-4" style={{ color: "rgba(240,240,245,0.5)" }}>
            Lesson 29 Complete · You now master WiFi, BLE, GPIO, PWM, Deep Sleep & MQTT
          </p>
          <motion.div
        ...
        <div className="mb-5">
          <div className="flex justify-between text-xs mb-1.5 font-mono" style={{ color: "rgba(240,240,245,0.4)" }}>
            <span>Lesson 29 of 36</span>
            <span style={{ color: COLOR }}>80% complete</span>
          </div>
        ...
        {/* All 29 lesson badges */}
        <div className="mb-5">
          <p className="text-xs font-mono mb-3" style={{ color: "rgba(240,240,245,0.3)" }}>All Completed Lessons (L01–L29)</p>
          <div className="grid grid-cols-7 gap-1.5">
            {ALL_LESSONS.map((name, i) => (
              <motion.div
                ...
                style={{
                  borderColor: i === 28 ? "rgba(6,182,212,0.5)" : "rgba(6,182,212,0.18)",
                  background: i === 28 ? "rgba(6,182,212,0.12)" : "rgba(6,182,212,0.05)",
                }}
              >
                <div className="text-[8px] font-black font-mono mb-0.5" style={{ color: i === 28 ? COLOR : "rgba(6,182,212,0.6)" }}>
                  L{String(i + 1).padStart(2, "0")}
                </div>
                <div className="text-[7px] leading-tight" style={{ color: i === 28 ? "rgba(240,240,245,0.8)" : "rgba(240,240,245,0.4)" }}>
                  {name}
                </div>
              </motion.div>
            ))}
        ...
        {/* What you learned */}
        <div className="rounded-2xl border p-4 mb-5" style={{ background: "rgba(6,182,212,0.05)", borderColor: "rgba(6,182,212,0.15)" }}>
          <div className="text-xs font-bold mb-2" style={{ color: COLOR }}>What you learned in this lesson:</div>
          <div className="grid grid-cols-2 gap-1">
            {[
              "Dual-core Xtensa LX6 architecture",
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <Link
            ...
            style={{ background: `linear-gradient(135deg, ${COLOR}, #22D3EE)`, color: "white" }}
          >
            Continue to STM32 →
          </Link>
        </div>
