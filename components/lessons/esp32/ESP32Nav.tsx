...
export default function ESP32Nav({ xp, onMenuClick }: Props) {
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-1.5 text-xs min-w-0">
        ...
        <span className="font-semibold truncate" style={{ color: COLOR }}>ESP32 Fundamentals</span>
      </div>
      ...
      <div
        ...
        style={{ background: "rgba(6,182,212,0.1)", border: "1px solid rgba(6,182,212,0.22)", color: COLOR }}
      >
      ...
      <Link
        ...
        style={{ color: COLOR, border: `1px solid rgba(6,182,212,0.3)`, background: "rgba(6,182,212,0.07)" }}
      >
        STM32 →
      </Link>
      ...
      <motion.div
        ...
        style={{ width: `${scrollPct}%`, background: `linear-gradient(90deg, ${COLOR}, #22D3EE)` }}
      />
    </nav>
  );
}
