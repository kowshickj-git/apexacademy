...
const lessons = [
  ...
  { num: "L29", title: "ESP32",              href: "/electronics/esp32",                   status: "active" },
...
export default function LearningPath({ milestones }: Props) {
  const milestoneKeys: (keyof Milestones)[] = ["lessonRead", "wifiScanUsed", "bleScanUsed", "gpioUsed", "pwmUsed", "deepSleepUsed", "mqttUsed", "quizPassed"];
          ...
          const inner = (
            ...
            >
              <div
                ...
                style={{ background: isDone ? "rgba(16,185,129,0.15)" : isActive ? "rgba(6,182,212,0.15)" : "rgba(255,255,255,0.06)" }}
              >
                {isDone ? (
