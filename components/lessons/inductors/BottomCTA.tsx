      ...
      <div className="max-w-2xl">
        ...
        >
          ...
          <p className="text-sm text-white/40 mb-4 leading-relaxed">
            Inductors that share magnetic fields. Transform voltages, isolate circuits, and transfer power efficiently between AC circuits.
          </p>
          <Link
        ...
        <div className="flex items-center justify-between border-t border-white/5 pt-5">
          ...
          >
            ...
            <span className="group-hover:underline underline-offset-2">Pull-Up/Down</span>
          </Link>
            ...
            <div className="flex gap-1">
              {Array.from({ length: 20 }).map((_, i) => (
                <div
                  ...
                  style={{ background: i < 15 ? "rgba(236,72,153,0.5)" : "rgba(255,255,255,0.08)" }}
                />
              ))}
            </div>
          </div>
