...
const CONFETTI_COLORS = ["#F59E0B", "#D97706", "#10B981", "#0EA5E9", "#8B5CF6", "#F97316", "#EC4899"];
const BADGE_SKILLS = ["Signal Stabilizer", "Floating Fixer", "Embedded Pro", "Quiz Champion"];
...
export default function PullupComplete({ xp, onClose }: Props) {
  ...
  return (
    ...
    >
      ...
      >
        {/* Amber header strip */}
        <div className="h-1.5" style={{ background: "linear-gradient(to right, #F59E0B, #D97706)" }} />
        ...
        <div className="p-6">
          ...
          <div className="text-center mb-5">
            ...
            <h2 className="text-xl font-black text-white mb-1">Pull-Up/Down Mastered!</h2>
            <p className="text-xs text-white/40 font-mono">Pull-Up &amp; Pull-Down Resistors — L14</p>
          </div>
          ...
          >
            ...
            <p
              ...
              style={{ background: "linear-gradient(to right, #F59E0B, #D97706)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}
            >
              {xp} XP
            </p>
          </div>

          {/* Progress bar — 14/20 = 70% */}
          <div className="mb-4">
            ...
            <div className="h-2 rounded-full overflow-hidden" style={{ background: "rgba(255,255,255,0.06)" }}>
              <div className="relative h-full rounded-full overflow-hidden" style={{ width: "65%", background: "rgba(245,158,11,0.15)" }}>
                <motion.div
                  initial={{ width: 0 }}
                  animate={{ width: "7.69%" }}
          ...
          >
            ...
            <p className="text-[10px] text-white/35 mt-0.5">Magnetic energy storage, coils, and inductance →</p>
          </Link>
