...
interface Milestones {
  ...
  pullupUsed: boolean;
  pulldownUsed: boolean;
  arduinoInputUsed: boolean;
    ...
    <div className="p-4">
      <div className="mb-4">
        <div className="flex justify-between text-xs text-white/40 mb-1.5">
          ...
          <span>14/36 lessons</span>
        </div>
        <div className="h-1.5 rounded-full overflow-hidden" style={{ background: "rgba(255,255,255,0.06)" }}>
          <div
            className="h-full rounded-full transition-all duration-700"
            style={{ width: "70%", background: "linear-gradient(to right, #F59E0B, #D97706)" }}
          />
        </div>
        ...
        <div className="h-1 rounded-full overflow-hidden mt-1" style={{ background: "rgba(255,255,255,0.04)" }}>
          <div
            className="h-full rounded-full transition-all duration-700"
            style={{ width: `${(progress / total) * 100}%`, background: "rgba(245,158,11,0.5)" }}
          />
        </div>
      </div>
          ...
          if (l.active) {
            return (
              <div
                ...
                style={{ background: "rgba(245,158,11,0.10)", borderColor: "rgba(245,158,11,0.3)" }}
              >
                <div
                ...
                <span className="text-xs font-semibold" style={{ color: "#F59E0B" }}>{l.title}</span>
                <div className="ml-auto w-1.5 h-1.5 rounded-full animate-pulse" style={{ background: "#F59E0B" }} />
              </div>
            );
          }
          if (l.available) {
