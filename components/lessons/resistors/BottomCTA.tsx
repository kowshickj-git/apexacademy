      ...
      <div className="max-w-2xl">
        ...
        >
          ...
          <div className="p-6 border-b border-white/5">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex-1">
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <span
                    className="text-[9px] px-2 py-0.5 rounded-full border border-white/10 text-white/25"
                  >
                    Coming Soon
                  </span>
                </div>
            ...
            <div
              className="mt-4 w-full py-2.5 rounded-xl text-sm font-bold text-center border border-white/8 text-white/25 cursor-not-allowed select-none"
            >
