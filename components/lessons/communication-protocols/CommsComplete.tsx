...
const COLOR = "#8B5CF6";
const CONFETTI_COLORS = ["#8B5CF6", "#A78BFA", "#FFFFFF", "#FFD700", "#FFC107", "#C4B5FD", "#EDE9FE", "#FBBF24"];
...
const ALL_LESSONS = [
  ...
  "Arduino", "Sensors", "Comms Protocols",
];

export default function CommsComplete({ xp, onClose }: Props) {
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        style={{ borderColor: "rgba(139,92,246,0.4)", background: "rgba(5,5,20,0.97)", backdropFilter: "blur(20px)" }}
      ...
      >
        ...
        <div className="text-center mb-6">
          ...
          <h2 className="text-3xl font-black mb-1" style={{ color: COLOR }}>Communication Protocols Mastered!</h2>
          <p className="text-sm mb-4" style={{ color: "rgba(240,240,245,0.5)" }}>
            Lesson 22 Complete · You now understand how devices talk to each other
          </p>
          <motion.div
        ...
        <div className="mb-5">
          <div className="flex justify-between text-xs mb-1.5 font-mono" style={{ color: "rgba(240,240,245,0.4)" }}>
            <span>Lesson 22 of 36</span>
            <span style={{ color: COLOR }}>61% complete</span>
          </div>
        ...
        {/* All 22 lesson badges */}
        <div className="mb-5">
          <p className="text-xs font-mono mb-3" style={{ color: "rgba(240,240,245,0.3)" }}>All Completed Lessons (L01–L22)</p>
          <div className="grid grid-cols-7 gap-1.5">
            {ALL_LESSONS.map((name, i) => (
              <motion.div
                ...
                animate={{ scale: 1, opacity: 1 }}
                transition={{ delay: 0.4 + i * 0.03, type: "spring", stiffness: 300, damping: 20 }}
                className="rounded-xl border p-1.5 text-center"
                style={{
                  borderColor: i === 21 ? "rgba(139,92,246,0.5)" : "rgba(139,92,246,0.18)",
                  background: i === 21 ? "rgba(139,92,246,0.12)" : "rgba(139,92,246,0.05)",
                }}
              >
                <div className="text-[8px] font-black font-mono mb-0.5" style={{ color: i === 21 ? COLOR : "rgba(139,92,246,0.6)" }}>
                  L{String(i + 1).padStart(2, "0")}
                </div>
                <div className="text-[7px] leading-tight" style={{ color: i === 21 ? "rgba(240,240,245,0.8)" : "rgba(240,240,245,0.4)" }}>
                  {name}
                </div>
              </motion.div>
            ))}
        ...
        {/* What you learned */}
        <div className="rounded-2xl border p-4 mb-5" style={{ background: "rgba(139,92,246,0.05)", borderColor: "rgba(139,92,246,0.15)" }}>
          <div className="text-xs font-bold mb-2" style={{ color: COLOR }}>What you learned in this lesson:</div>
          <div className="grid grid-cols-2 gap-1">
            {[
              "Serial vs Parallel",
              "Sync vs Async",
              "Full/Half/Simplex Duplex",
              "UART overview",
              "I2C bus protocol",
              "SPI high-speed",
              "CAN automotive",
