  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-1.5 text-xs min-w-0">
        ...
        <span className="font-semibold truncate" style={{ color: COLOR }}>Communication Protocols</span>
      </div>
      ...
      <div
        ...
        style={{ background: "rgba(139,92,246,0.1)", border: "1px solid rgba(139,92,246,0.22)", color: COLOR }}
      >
      ...
      <Link
        ...
        style={{ color: COLOR, border: `1px solid rgba(139,92,246,0.3)`, background: "rgba(139,92,246,0.07)" }}
      >
        UART →
      </Link>
      ...
      <motion.div
        ...
        style={{ width: `${scrollPct}%`, background: `linear-gradient(90deg, ${COLOR}, #A78BFA)` }}
      />
    </nav>
  );
}
