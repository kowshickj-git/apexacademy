...
interface Milestones {
  lessonRead: boolean;
  serialSimUsed: boolean;
  syncAsyncUsed: boolean;
  duplexUsed: boolean;
  chooserUsed: boolean;
  wiringUsed: boolean;
  quizPassed: boolean;
...
const lessons = [
  ...
  { num: "L22", title: "Comms Protocols",      href: "/electronics/communication-protocols",   active: true },
  { num: "L23", title: "UART",                 href: "/electronics/uart",                      available: true },
  { num: "L24", title: "I2C",                  href: "/electronics/i2c",                       available: true },
  { num: "L25", title: "SPI",                  href: "/electronics/spi",                       available: true },
  { num: "L26", title: "CAN Protocol",         href: "/electronics/can",                       available: true },
...
export default function LearningPath({ milestones }: Props) {
  const milestoneKeys: (keyof Milestones)[] = ["lessonRead", "serialSimUsed", "syncAsyncUsed", "duplexUsed", "chooserUsed", "wiringUsed", "quizPassed"];
  ...
  return (
    <div className="p-4 pt-16">
      ...
      <div className="space-y-0.5">
        {lessons.map((l) => {
          const isLocked = !!(l as any).locked;
          const isDone = !!(l as any).done;
          ...
          const inner = (
            ...
            >
              <div
                ...
                style={{ background: isDone ? "rgba(16,185,129,0.15)" : isActive ? "rgba(139,92,246,0.15)" : "rgba(255,255,255,0.06)" }}
              >
                {isDone ? (
