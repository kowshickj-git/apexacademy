...
const lessons = [
  ...
  { id: "L12", title: "Parallel Circuits",   href: "/electronics/parallel-circuits",  done: true },
  { id: "L13", title: "Switches",            href: "/electronics/switches",           done: true },
  { id: "L14", title: "Pull-Up/Down",        href: "/electronics/pullup-pulldown",    done: true },
  { id: "L15", title: "Inductors",           href: "/electronics/inductors",          done: true },
  { id: "L16", title: "Transformers",        href: "/electronics/transformers",       active: true },
  ...
  { id: "L21", title: "Sensors",           href: "/electronics/sensors",                 available: true },
  { id: "L22", title: "Comm Protocols",    href: "/electronics/communication-protocols", available: true },
  { id: "L23", title: "UART",             href: "/electronics/uart",                    available: true },
  { id: "L24", title: "I2C",             href: "/electronics/i2c",                     available: true },
  { id: "L25", title: "SPI",             href: "/electronics/spi",                     available: true },
  { id: "L26", title: "CAN Protocol",    href: "/electronics/can",                     available: true },
  { id: "L27", title: "RS485",           href: "/electronics/rs485",                   available: true },
  { id: "L28", title: "IoT",             href: "/electronics/iot",                     available: true },
  { id: "L29", title: "ESP32",           href: "/electronics/esp32",                   available: true },
  { id: "L30", title: "STM32",           href: "/electronics/stm32",                   available: true },
  { id: "L31", title: "FreeRTOS",        href: "/electronics/freertos",                locked: true },
  { id: "L32", title: "PCB Design",      href: "/electronics/pcb-design",              locked: true },
  { id: "L33", title: "Embedded",        href: "/electronics/embedded-projects",       locked: true },
  { id: "L34", title: "Robotics",        href: "/electronics/robotics",                locked: true },
  { id: "L35", title: "Computer Vision", href: "/electronics/computer-vision",         locked: true },
  { id: "L36", title: "AI Robotics",     href: "/electronics/ai-robotics",             locked: true },
];
  ...
  return (
    <div className="p-4">
      <div className="mb-4">
        ...
        <div className="h-1.5 rounded-full overflow-hidden" style={{ background: "rgba(255,255,255,0.06)" }}>
          <div
            ...
            style={{ width: "80%", background: "linear-gradient(to right, #8B5CF6, #7C3AED)" }}
          />
        </div>
        ...
        <div className="h-1 rounded-full overflow-hidden mt-1" style={{ background: "rgba(255,255,255,0.04)" }}>
          <div
            className="h-full rounded-full transition-all duration-700"
            style={{ width: `${(progress / total) * 100}%`, background: "rgba(139,92,246,0.5)" }}
          />
        </div>
      </div>
        ...
        {lessons.map((l) => {
          ...
          if (l.active) {
            return (
              <div
                ...
                style={{ background: "rgba(139,92,246,0.10)", borderColor: "rgba(139,92,246,0.3)" }}
              >
                <div
                ...
                <span className="text-xs font-semibold" style={{ color: "#8B5CF6" }}>{l.title}</span>
                <div className="ml-auto w-1.5 h-1.5 rounded-full animate-pulse" style={{ background: "#8B5CF6" }} />
              </div>
            );
          }
          // done
          return (
            <Link key={l.id} href={l.href} className="flex items-center gap-3 px-3 py-2.5 rounded-xl hover:bg-white/4 transition-colors">
              ...
              <span className="ml-auto text-[9px] text-white/30 font-mono">✓</span>
            </Link>
          );
        })}
      </div>
      ...
      <div className="mt-4 pt-4 border-t border-white/5">
        <p className="text-[10px] text-white/20 text-center">Electronics Fundamentals · 36 Lessons</p>
      </div>
    </div>
  );
}
