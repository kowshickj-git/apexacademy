...
const lessons = [
  ...
  { id: "L13", title: "Capacitors II",       href: "/electronics/capacitors",         done: true },
  { id: "L14", title: "RC Circuits",         href: "/electronics/rc-circuits",        done: true },
  ...
  { id: "L17", title: "BJT Transistors",     href: "/electronics/bjt",               available: true },
  { id: "L18", title: "MOSFETs",            href: "/electronics/mosfets",           available: true },
  { id: "L19", title: "Op-Amps",            href: "/electronics/op-amps",           available: true },
  { id: "L20", title: "Digital Logic",       href: "/electronics/digital-logic",      available: true },
];
  ...
  return (
    <div className="p-4">
      ...
      <div className="mt-4 pt-4 border-t border-white/5">
        <p className="text-[10px] text-white/20 text-center">Electronics Fundamentals · 20 Lessons</p>
      </div>
    </div>
  );
}
