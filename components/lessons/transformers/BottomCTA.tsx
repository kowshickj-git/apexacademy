      ...
      <div className="max-w-2xl">
        ...
        >
          ...
          <p className="text-sm text-white/40 mb-4 leading-relaxed">
            Learn how bipolar junction transistors use small base currents to control large collector currents — the building block of amplifiers and digital logic.
          </p>
          <Link
        ...
        <div className="flex items-center justify-between border-t border-white/5 pt-5">
          ...
          >
            ...
            <span className="group-hover:underline underline-offset-2">Inductors</span>
          </Link>

          <div className="flex items-center gap-2">
            <span className="text-[10px] text-white/15 font-mono">L16 of 20</span>
            <div className="flex gap-1">
              {Array.from({ length: 20 }).map((_, i) => (
                <div
                  ...
                  style={{
                    background: i < 16 ? "rgba(139,92,246,0.5)" : "rgba(255,255,255,0.1)",
                  }}
                />
              ))}
            </div>
