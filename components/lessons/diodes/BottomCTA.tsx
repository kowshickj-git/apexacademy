        ...
        >
          <div className="p-6 border-b border-white/5">
            ...
            <div className="flex items-center gap-4">
              <div
                className="w-14 h-14 rounded-2xl border border-red-500/20 flex items-center justify-center text-2xl shrink-0"
              ...
              <div className="flex-1">
                <div className="flex items-center gap-2 mb-1">
                  <h3 className="text-base font-bold text-white/80">Lesson 08: LED Fundamentals</h3>
                  <span
                ...
                <p className="text-xs text-white/40 leading-relaxed">
                  Master LED polarity, resistor calculations, RGB colour mixing and the physics of electroluminescence.
                </p>
              </div>
            </div>
            <Link
            ...
            >
              Start Lesson 8: LED Fundamentals →
            </Link>
          </div>
