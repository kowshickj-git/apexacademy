...
const CYAN = "#06B6D4";
const CONFETTI_COLORS = [CYAN, "#ffffff", "#0891b2", "#22d3ee", "#67e8f9", "#a5f3fc", "#10B981", "#06b6d4"];

const BADGES = ["Circuit Controller", "Button Master", "NO/NC Expert", "Quiz Champion"];
...
export default function SwitchesComplete({ xp, onClose }: Props) {
  ...
  return (
    ...
    >
      ...
      >
        {/* Header strip */}
        <div className="h-1.5" style={{ background: `linear-gradient(to right, ${CYAN}, #0891b2)` }} />
        ...
        <div className="p-6">
          ...
          <div className="text-center mb-5">
            ...
            <h2 className="text-xl font-black text-white mb-1">Switches Mastered!</h2>
            <p className="text-xs text-white/40 font-mono">Switches & Push Buttons — L13</p>
          </div>
          ...
          >
            ...
            <p
              ...
              style={{ background: `linear-gradient(to right, ${CYAN}, #0891b2)`, WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}
            >
              {xp} XP
            </p>
          </div>

          {/* Progress bar: 13/20 = 65% */}
          <div className="mb-4">
            ...
            <div className="h-2 rounded-full overflow-hidden" style={{ background: "rgba(255,255,255,0.06)" }}>
              <div className="relative h-full rounded-full overflow-hidden" style={{ width: "60%", background: "rgba(6,182,212,0.2)" }}>
                <motion.div
                  initial={{ width: 0 }}
                  animate={{ width: "8.33%" }}
                  transition={{ duration: 1, delay: 0.5 }}
                  className="absolute right-0 top-0 h-full rounded-full"
                  style={{ background: `linear-gradient(to right, ${CYAN}, #0891b2)` }}
                />
              </div>
            </div>
          </div>
            ...
            <div className="flex flex-wrap gap-2">
              {BADGES.map((badge, i) => (
                <motion.div
                  ...
                  style={{ borderColor: "rgba(6,182,212,0.3)", background: "rgba(6,182,212,0.1)", color: CYAN }}
                >
                  ✓ {badge}
                </motion.div>
              ))}
          ...
          >
            ...
            <p className="text-sm font-bold text-white/85 group-hover:text-white transition-colors">
              Lesson 14: Pull-Up/Pull-Down Resistors
            </p>
            <p className="text-[10px] text-white/35 mt-0.5">Master INPUT_PULLUP and voltage dividers →</p>
          </Link>
