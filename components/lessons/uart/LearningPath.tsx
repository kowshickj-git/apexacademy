...
const lessons = [
  ...
  { num: "L23", title: "UART",                href: "/electronics/uart",                    active: true },
...
export default function LearningPath({ milestones }: Props) {
  const milestoneKeys: (keyof Milestones)[] = ["lessonRead", "senderUsed", "baudUsed", "txrxUsed", "monitorUsed", "debuggerUsed", "quizPassed"];
  ...
  return (
    <div className="p-4 pt-16">
      {/* Progress bar */}
      <div className="mb-4 p-3 rounded-xl" style={{ background: "rgba(16,185,129,0.06)", border: "1px solid rgba(16,185,129,0.15)" }}>
          ...
          const inner = (
            ...
            >
              <div
                ...
                style={{ background: isDone ? "rgba(16,185,129,0.15)" : isActive ? "rgba(16,185,129,0.15)" : "rgba(255,255,255,0.06)" }}
              >
                {isDone ? (
