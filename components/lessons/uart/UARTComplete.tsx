...
const COLOR = "#10B981";
const CONFETTI_COLORS = ["#10B981", "#34D399", "#FFFFFF", "#FFD700", "#FFC107", "#6EE7B7", "#A7F3D0", "#FBBF24"];
...
const ALL_LESSONS = [
  ...
  "Arduino", "Sensors", "Comms Protocols", "UART",
];
...
export default function UARTComplete({ xp, onClose }: Props) {
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        style={{ borderColor: "rgba(16,185,129,0.4)", background: "rgba(5,5,20,0.97)", backdropFilter: "blur(20px)" }}
      ...
      >
        ...
        <div className="text-center mb-6">
          ...
          <h2 className="text-3xl font-black mb-1" style={{ color: COLOR }}>UART Mastered!</h2>
          <p className="text-sm mb-4" style={{ color: "rgba(240,240,245,0.5)" }}>
            Lesson 23 Complete · You now understand UART serial communication
          </p>
          <motion.div
        ...
        <div className="mb-5">
          <div className="flex justify-between text-xs mb-1.5 font-mono" style={{ color: "rgba(240,240,245,0.4)" }}>
            <span>Lesson 23 of 36</span>
            <span style={{ color: COLOR }}>64% complete</span>
          </div>
        ...
        {/* All 23 lesson badges */}
        <div className="mb-5">
          <p className="text-xs font-mono mb-3" style={{ color: "rgba(240,240,245,0.3)" }}>All Completed Lessons (L01–L23)</p>
          <div className="grid grid-cols-8 gap-1.5">
            {ALL_LESSONS.map((name, i) => (
              <motion.div
                ...
                style={{
                  borderColor: i === 22 ? "rgba(16,185,129,0.5)" : "rgba(16,185,129,0.18)",
                  background: i === 22 ? "rgba(16,185,129,0.12)" : "rgba(16,185,129,0.05)",
                }}
              >
                <div className="text-[8px] font-black font-mono mb-0.5" style={{ color: i === 22 ? COLOR : "rgba(16,185,129,0.6)" }}>
                  L{String(i + 1).padStart(2, "0")}
                </div>
                <div className="text-[7px] leading-tight" style={{ color: i === 22 ? "rgba(240,240,245,0.8)" : "rgba(240,240,245,0.4)" }}>
                  {name}
                </div>
              </motion.div>
            ))}
        ...
        {/* What you learned */}
        <div className="rounded-2xl border p-4 mb-5" style={{ background: "rgba(16,185,129,0.05)", borderColor: "rgba(16,185,129,0.15)" }}>
