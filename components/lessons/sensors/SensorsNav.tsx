...
export default function SensorsNav({ xp, onMenuClick }: Props) {
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-1.5 text-xs min-w-0">
        ...
        <span className="font-semibold truncate" style={{ color: COLOR }}>Sensors Fundamentals</span>
      </div>

      {/* Lesson badge */}
      <span
        className="hidden sm:inline-block text-xs font-mono px-2 py-0.5 rounded-full flex-shrink-0"
        style={{ background: "rgba(14,165,233,0.1)", color: "rgba(14,165,233,0.7)", border: "1px solid rgba(14,165,233,0.2)" }}
      >
        L21 of 36
      </span>
      ...
      <div
        ...
        style={{ background: "rgba(14,165,233,0.1)", border: "1px solid rgba(14,165,233,0.22)", color: COLOR }}
      >
      ...
      <Link
        ...
        style={{ color: COLOR, border: `1px solid rgba(14,165,233,0.3)`, background: "rgba(14,165,233,0.07)" }}
      >
        Comms →
      </Link>
      ...
      <motion.div
        ...
        style={{ width: `${scrollPct}%`, background: `linear-gradient(90deg, ${COLOR}, #38BDF8)` }}
      />
    </nav>
  );
}
