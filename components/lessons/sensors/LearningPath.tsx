...
const lessons = [
  ...
  { num: "L21", title: "Sensors",           href: "/electronics/sensors",                 active: true },
  { num: "L22", title: "Comms Protocols",   href: "/electronics/communication-protocols", available: true },
...
export default function LearningPath({ milestones }: Props) {
  const milestoneKeys: (keyof Milestones)[] = ["lessonRead", "ultrasonicUsed", "tempUsed", "ldrUsed", "motionUsed", "dashboardUsed", "quizPassed"];
          ...
          const inner = (
            ...
            >
              <div
                ...
                style={{ background: isDone ? "rgba(16,185,129,0.15)" : isActive ? "rgba(14,165,233,0.15)" : "rgba(255,255,255,0.06)" }}
              >
                {isDone ? (
