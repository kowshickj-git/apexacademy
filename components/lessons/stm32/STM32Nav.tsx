...
export default function STM32Nav({ xp, onMenuClick }: Props) {
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-1.5 text-xs min-w-0">
        ...
        <span className="font-semibold truncate" style={{ color: COLOR }}>STM32 Fundamentals</span>
      </div>

      <span
        className="hidden sm:inline-block text-xs font-mono px-2 py-0.5 rounded-full flex-shrink-0"
        style={{ background: "rgba(8,145,178,0.1)", color: "rgba(8,145,178,0.7)", border: "1px solid rgba(8,145,178,0.2)" }}
      >
        L30 · STM32
      </span>
      ...
      <div
        ...
        style={{ background: "rgba(8,145,178,0.1)", border: "1px solid rgba(8,145,178,0.22)", color: COLOR }}
      >
      ...
      <Link
        ...
        style={{ color: COLOR, border: `1px solid rgba(8,145,178,0.3)`, background: "rgba(8,145,178,0.07)" }}
      >
        FreeRTOS →
      </Link>
      ...
      <motion.div
        ...
        style={{ width: `${scrollPct}%`, background: `linear-gradient(90deg, ${COLOR}, #06B6D4)` }}
      />
    </nav>
  );
}
