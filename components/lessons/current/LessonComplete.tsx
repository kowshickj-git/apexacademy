...
export default function LessonComplete({ xp, onClose }: LessonCompleteProps) {
    ...
    >
      ...
      >
        ...
        <p className="text-sm text-white/45 mb-5">
          You&apos;ve mastered Current Fundamentals
        </p>

        {/* XP display */}
        <div
          className="rounded-2xl border border-primary/25 p-4 mb-4"
          style={{ background: "rgba(16,185,129,0.07)" }}
        >
          <p className="text-[10px] text-white/28 uppercase tracking-widest font-semibold mb-1.5">
            XP Earned
          </p>
        ...
        >
          ...
          <span className="text-xs text-secondary font-semibold">Lesson 3: Resistance — Unlocked!</span>
        </div>
