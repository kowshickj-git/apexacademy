      ...
      <div className="mb-4">
        ...
        <div className="h-1.5 rounded-full overflow-hidden" style={{ background: "rgba(255,255,255,0.06)" }}>
          <div
            ...
            style={{ width: `${(progress / total) * 100}%`, background: "linear-gradient(to right, #F59E0B, #EF4444, #10B981)" }}
          />
        </div>
      </div>
            ...
            {(l as any).locked ? (
              ...
              >
                <div
                  ...
                  style={{ background: "rgba(239,68,68,0.18)", borderColor: "rgba(239,68,68,0.4)", color: "#FCA5A5" }}
                >
                  {l.id.slice(1)}
                </div>
                <span className="text-xs font-semibold" style={{ color: "#FCA5A5" }}>{l.title}</span>
