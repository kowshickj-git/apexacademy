...
const COLOR = "#F59E0B";
const CONFETTI_COLORS = [COLOR, "#FCD34D", "#FFFFFF", "#FFD700", "#FDE68A", "#FBBF24", "#F97316", "#FCA5A5"];
...
const ALL_LESSONS = [
  ...
  "Arduino", "Sensors", "Comms", "UART", "I2C", "SPI", "CAN", "RS485",
];

const ACHIEVEMENTS = [
  { icon: "📡", label: "Differential Expert", desc: "Mastered differential signaling" },
  { icon: "🏭", label: "Industrial Pro", desc: "Understood Modbus RTU" },
  { icon: "🔌", label: "Bus Architect", desc: "Built multi-drop RS485 networks" },
  { icon: "⚡", label: "Noise Immune", desc: "Proved common-mode rejection" },
];

export default function RS485Complete({ xp, onClose }: Props) {
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        style={{ borderColor: "rgba(245,158,11,0.4)", background: "rgba(5,5,20,0.97)", backdropFilter: "blur(20px)" }}
      ...
      >
        ...
        <div className="text-center mb-6">
          ...
          <h2
            ...
            style={{ background: `linear-gradient(135deg, ${COLOR}, #FCD34D)`, WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}
          >
            RS485 Mastered!
          </h2>
          <p className="text-sm mb-4" style={{ color: "rgba(240,240,245,0.5)" }}>
            Lesson 27 of 36 Complete · Industrial Communication Expert
          </p>
          <motion.div
        ...
        <div className="mb-5">
          <div className="flex justify-between text-xs mb-1.5 font-mono" style={{ color: "rgba(240,240,245,0.4)" }}>
            <span>Lesson 27 of 36</span>
            <span style={{ color: COLOR }}>75% complete</span>
          </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 mb-5">
          {ACHIEVEMENTS.map((a, i) => (
            ...
            >
              ...
              <div className="text-[9px] font-black mb-0.5" style={{ color: COLOR }}>{a.label}</div>
              <div className="text-[8px]" style={{ color: "rgba(240,240,245,0.4)" }}>{a.desc}</div>
            </motion.div>
          ))}
        </div>
        ...
        <div className="mb-5">
          <p className="text-xs font-mono mb-3" style={{ color: "rgba(240,240,245,0.3)" }}>All Completed Lessons (L01–L27)</p>
          <div className="grid grid-cols-9 gap-1">
            {ALL_LESSONS.map((name, i) => (
              <motion.div
                ...
                style={{
                  borderColor: i === 26 ? "rgba(245,158,11,0.5)" : "rgba(245,158,11,0.15)",
                  background: i === 26 ? "rgba(245,158,11,0.12)" : "rgba(245,158,11,0.04)",
                }}
              >
                <div className="text-[7px] font-black font-mono" style={{ color: i === 26 ? COLOR : "rgba(245,158,11,0.5)" }}>
                  L{String(i + 1).padStart(2, "0")}
                </div>
                <div className="text-[6px] leading-tight mt-0.5" style={{ color: i === 26 ? "rgba(240,240,245,0.8)" : "rgba(240,240,245,0.35)" }}>
                  {name}
                </div>
              </motion.div>
            ))}
        ...
        {/* What you learned */}
        <div className="rounded-2xl border p-4 mb-5" style={{ background: "rgba(245,158,11,0.05)", borderColor: "rgba(245,158,11,0.15)" }}>
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <Link
            ...
            style={{ background: `linear-gradient(135deg, ${COLOR}, #FCD34D)`, color: "#050507" }}
          >
            Start IoT →
          </Link>
        </div>
