...
const lessons = [
  ...
  { num: "L26", title: "CAN Protocol",      href: "/electronics/can",                     done: true },
  { num: "L27", title: "RS485",             href: "/electronics/rs485",                   active: true },
              ...
              >
                {isDone ? (
                  ...
                  <svg width="9" height="9" viewBox="0 0 10 10" fill="none">
                    <path d="M3 5h4M5.5 3.5L7 5l-1.5 1.5" stroke={isAvailable ? "rgba(245,158,11,0.5)" : "rgba(240,240,245,0.35)"} strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
                )}
              </div>
